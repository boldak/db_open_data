...
![alt text](./Diagram1.png "Open data management system")
...
***ВИКЛЮЧНІ СИТУАЦІЇ:*** EX 001ADMIN Невірний логін чи пароль
...
***ВИКЛЮЧНІ СИТУАЦІЇ:*** EX 002ADMIN Такий модератор вже присутній в системі
...
- 2. Адміністратор змінює стату набору даних 
...
***РЕЗУЛЬТАТ:*** Вілповідь адміністратора додана

***ВИКЛЮЧНІ СИТУАЦІЇ:*** EX 003ADMIN Відповідь на коментар не може бути пустою
...
***ВИКЛЮЧНІ СИТУАЦІЇ:*** EX 001MODER Невірний логін чи пароль
...
***ВИКЛЮЧНІ СИТУАЦІЇ:*** EX 003MODER Відповідь на коментар не може бути пустою
...
***ВИКЛЮЧНІ СИТУАЦІЇ:*** EX 001USER По даному запиту набір даних не знайдено
...
***ВИКЛЮЧНІ СИТУАЦІЇ:*** EX 002USER Невірний логін чи пароль
...
***ВИКЛЮЧНІ СИТУАЦІЇ:*** EX 002USER Коментар не може бути пустим 
                         EX 002USER Коментар не може бути довшим ніж 999 символів
**ОСНОВНИЙ СЦЕНАРІЙ:*** 
